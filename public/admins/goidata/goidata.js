document.addEventListener('DOMContentLoaded', function () {
    ...
    // Thay đổi trạng thái
    $('#goidatasTable').on('click', '.status-toggle', function () {
    ...
    // Xử lý thêm Gói data
    document.getElementById('goidataForm').addEventListener('submit', function (e) {
        ...
        fetch(routes.store, {
            ...
            .then(data => {
                if (data.success) {
                    ...
                    document.getElementById('goidataForm').reset();
                    $('#goidatasTable').DataTable().ajax.reload();
                } else {
                    Swal.fire({
                        icon: 'error',
