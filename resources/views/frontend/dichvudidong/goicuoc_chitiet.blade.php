...
<div class="container" style="padding-top: 15vh;">
    ...
    <div class="card shadow-sm mb-4 p-4">
        <div class="d-flex align-items-center">
            ...
            <div class="flex-grow-1">
                <h3 class="fw-bold text-primary">{{ $goi->ten_goicuoc }}</h3>
    ...
    <div class="card shadow-sm mb-4 card-with-bg">
        ...
        <div class="card-body">
            @if ($goicuocDetails->isNotEmpty())
                @foreach ($goicuocDetails as $detail)
                    <div class="mb-3">
...
<div class="mt-5">
    ...
    <div class="row">
        @foreach ($relatedGoicuocs as $related)
...
<script src="{{ asset('frontends/goicuoc/goicuoc_chitiet.js') }}"></script>
