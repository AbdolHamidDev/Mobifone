...
return new class extends Migration
{
    ...
    {
        Schema::create('goidatas', function (Blueprint $table) {
            $table->id();
            $table->string('ten_data'); // Tên gói cước (ví dụ: D5)
            ...
            $table->string('loai_data')->nullable(); // Loại gói cước
